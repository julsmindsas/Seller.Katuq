...
- **Pendiente:** E2E manual con empresa piloto (flag ON vía `scripts/seed-treasury-flag.js`) → sello D-TESORERIA-MVP. Rol "Tesorero" se crea en el maestro de roles al activar el piloto.
