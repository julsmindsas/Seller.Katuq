...
- **Estado:** sin cambios de código; solo documentación (findings.md §F-14 + esta bitácora). Producción intacta. Pendientes de rollout (puntos 2-4 de la sesión previa) siguen abiertos.
