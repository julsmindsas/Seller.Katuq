...
Fecha: 2026-07-23. Rama local: `codex/inventory-stabilization-openspec`. No desplegado y sin lecturas nuevas de producción.
...
- No existe todavía un endpoint/pantalla/export de corte para usuario final.
- Falta confirmar PITR y capturar el primer ancla verificada con `snapshot-time` después de estabilizar el ledger.
- Falta probar traslado, reversa, paginación/export grande y comparación contra muestras manuales.
