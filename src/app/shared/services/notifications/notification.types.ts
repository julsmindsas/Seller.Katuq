...
export enum NotificationType {
  ...
  SIIGO_INVOICE_CREATED = 'SIIGO_INVOICE_CREATED',
  SIIGO_INVOICE_FAILED = 'SIIGO_INVOICE_FAILED',
  SIIGO_INVOICE_PROCESSING = 'SIIGO_INVOICE_PROCESSING',
  SIIGO_CUSTOMER_CREATED = 'SIIGO_CUSTOMER_CREATED',
  SIIGO_PRODUCT_SYNCED = 'SIIGO_PRODUCT_SYNCED',
