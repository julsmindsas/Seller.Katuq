...
export const AGENT_UI_CONFIG: Record<string, Partial<ChatProSpeaker>> = {
    ...
    inventory_voter: {
        display_name: 'Votante Inventario',
        type: 'department',
        department: 'inventory',
        color: '#f59e0b',
        avatar: 'pi-box'
    ...
    logistics_voter: {
        display_name: 'Votante Logistica',
        type: 'department',
        department: 'logistics',
        color: '#3b82f6',
        avatar: 'pi-truck'
    ...
    consensus_resolver: {
        display_name: 'Sistema de Consenso',
        type: 'system',
        department: null,
        color: '#8b5cf6',
        avatar: 'pi-sitemap'
    ...
    voting_round: {
        display_name: 'Ronda de Votacion',
        type: 'system',
        department: null,
        color: '#ec4899',
        avatar: 'pi-share-alt'
