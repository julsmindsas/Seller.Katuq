...
export class IntegrationUIHelperService {
  ...
  private readonly typeToCategory: { [key: string]: IntegrationCategory } = {
    ...
    partners_logistics: IntegrationCategory.LOGISTICS,
    aliaddo_fulfillment: IntegrationCategory.LOGISTICS,
    prindel: IntegrationCategory.LOGISTICS,
  ...
  private integrationFeatures = {
    ...
    partners_logistics: ['Integración personalizada', 'API flexible', 'Webhooks', 'Configuración avanzada'],
    prindel: ['Envíos última milla', 'Tracking en tiempo real', 'Contraentrega', 'Cobertura Colombia'],
  ...
  private documentationUrls = {
    ...
    partners_logistics: null, // Documentación personalizada del partner
    prindel: 'https://api.prindel.com.co/swagger/doc.json',
  ...
  private integrationIcons = {
    ...
    partners_logistics: 'fa-handshake',
    aliaddo_fulfillment: 'fa-boxes',
    prindel: 'fa-truck-fast',
  ...
  private validateCredentialsObject(credentials: any, integrationType: string): boolean {
    ...
    switch (integrationType) {
      case 'shopify':
        return !!(credentials.shopUrl && credentials.clientId && credentials.clientSecret);
      case 'wompi':
